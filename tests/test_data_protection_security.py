...
class WebhookSecurityTests(unittest.TestCase):
    ...
    def test_webhook_idempotency(self):
        ...
        response1 = self.client.post('/post/allocate', data=payload, content_type='application/json')
        response2 = self.client.post('/post/allocate', data=payload, content_type='application/json')
...
class FileUploadSecurityTests(unittest.TestCase):
    ...
    def test_file_type_validation(self):
        ...
        response = self.client.post('/upload', data={
            'file': (b'malicious code', 'script.exe')
        })
